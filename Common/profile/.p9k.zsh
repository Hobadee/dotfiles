...
# $ICON_OS > ITM-ERICK > $ICON_FOLDER ~/src/ansible/ceph-ansible > $ICON_GIT_BRANCH v4.0.5 $ICON_GIT_TAG v4.0.5 ▓▒░
# ░▒▓ $ICON_CMD_STATUS > 0.1s $ICON_HOURGLASS > 1428 $ICON_HIST  > 10:07:01 $ICON_CLOCK > 243 Mbps $ICON_WIFI > 6.24G $ICON_SPEED 4.64 $ICON_BARGRAPH  > 100% $ICON_BATTERY

# Right Todo:
# ░▒▓ $ICON_CMD_STATUS > 243 Mbps $ICON_WIFI 
