# Generated by Powerlevel10k configuration wizard on 2020-01-15 at 10:05 PST.
...
# slanted separators, blurred heads, round tails, 2 lines, solid, no frame, sparse,
# many icons, concise.
...
() {
  ...
  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      ...
      disk_avail_pct          # Custom: Shows drive space available
      vcs                     # git status
      # =========================[ Line #2 ]=========================
      newline
      time
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      background_jobs         # if background jobs are running or not
      command_execution_time  # duration of the last command
      # history                 # id of the last command?
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=69
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=69
  ...
  # Only show when using one of the following commands
